...
*-----设置系统公共变量-------------------------
RELEASE c版本号,c版权,cSqlServer,cLng,cColor,cCustomer,cWidth,cHeight 
PUBLIC  c版本号,c版权,cSqlServer,cLng,cColor,cCustomer,cWidth,cHeight 

c版本号="包租公房屋管理系统 Ver 1.0"
...
For I=1 To lnConfigStrLine
    ...
    Do Case
        ...
        Case Upper('Customer=')$lcRowStr
            cCustomer=LOWER(Alltrim(Strextract(lcRowStr,Upper('Customer=')))) && 默认客户
    Endcase
ENDFOR
*--------------------------------------------------------------------------------------
